"""
This tool is borrowed and modified from the link below
...
def make_edge_smooth(path):
    file_list = glob(os.path.expanduser(os.path.join(path, 'style', '*')))
    save_dir = os.path.expanduser(os.path.join(path, 'style_smooth'))
...
if __name__ == '__main__':
    ...
    main("C:/Users/21300/Desktop/Dataset/Anime")        #what you need to change